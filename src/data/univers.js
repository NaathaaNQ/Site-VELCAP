...
export const univers = [
  {
    ...
    note: 'Sorties et entraînements orientés trail & route, encadrés par nos coachs certifiés.',
    schedule: ['Mardi · 19h00 – 20h30', 'Jeudi · 19h00 – 20h30'],
    tiers: [
      {
        name: 'Adhésion Communauté',
        price: '180 €',
        features: [
          '2 entraînements encadrés / semaine (mardi & jeudi, 19h–20h30)',
      ...
      },
      {
        ...
        highlight: true,
        features: [
          "Tout l'offre Communauté, et en plus :",
  ...
  },
  {
    ...
    index: '03',
    name: 'Club FFA',
    discipline: 'Athlétisme · jeunes & compétition',
    lead: 'Former les jeunes, ouvrir la compétition à tous.',
    intro:
      "Démocratiser la formation des jeunes en trail, sur route et sur piste. Un encadrement structuré dès le plus jeune âge pour exploiter tout le potentiel de demain — et l'accès à la licence FFA et à la compétition pour toutes et tous.",
    points: [
      { k: 'Deux créneaux / semaine', v: 'Lundi & mercredi dès 18h30 — un créneau du samedi à venir.' },
  ...
  },
  {
    ...
    lead: 'Bientôt.',
    intro:
      "Le projet cyclisme se dessine. Les contours du club FFC arrivent — laisse-nous tes coordonnées pour être prévenu dès l'ouverture.",
    comingSoon: true,
  ...
  },
  {
    ...
    events: [
      ...
      'Social ride — pros du sport & assos',
      'Stages',
    ],
    request:
